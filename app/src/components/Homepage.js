            ...
            <div className="container vh-100" id="bg">
                <div className="row flex-column justify-content-center align-items-center h-75">
                    ...
                    <div className="col-6 d-flex justify-content-center pt-5 pb-2">
                        <button onClick={() => {navigate('/login')}} className="btn btn-lg btn-outline-info">Log-in</button>
                    </div>
                    <div className="col-6 d-flex justify-content-center">
                        <button onClick={() => {navigate('/signup')}} className="btn btn-lg btn-outline-info">Sign-up</button>
                    </div>
                </div>
